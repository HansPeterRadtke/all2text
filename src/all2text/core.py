    ...
    *,
    ...
    manifest = {
        ...
        "options": {
            ...
            "interactive_setup_prompt": options.interactive_setup_prompt,
            "setup_tools_dir": options.setup_tools_dir,
            "setup_models_dir": options.setup_models_dir,
            "setup_report_path": options.setup_report_path,
        },
